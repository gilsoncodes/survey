<div class="flex flex-col">
  <div class="w-full mb-4 font-bold">
    {{ __('This survey is for a college writing course project. Your participation is highly appreciated, and your answers are anonymous.') }}
  </div>
  ...
  <form wire:submit.prevent="submitForm">
    ...
    <div class="flex items-center mb-4 mt-2 ">
      ...
      <label for="answer-Q-1a" class="ml-2 text-sm font-medium">{{ __('Not once') }}</label>

      <input wire:model="question1" id="answer-Q-1b" wire:click="errorQuestion1" type="radio" value="Once" class="ml-3 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      <label for="answer-Q-1b" class="ml-2 text-sm font-medium">{{ __('Once') }}</label>

      <input wire:model="question1" id="answer-Q-1c" wire:click="errorQuestion1" type="radio" value="Two or three times" class="ml-3 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      <label for="answer-Q-1c" class="ml-2 text-sm font-medium">{{ __('Two or three times') }}</label>

      <input wire:model="question1" id="answer-Q-1d" wire:click="errorQuestion1" type="radio" value="Four times or more"  class="ml-3 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      <label for="answer-Q-1d" class="ml-2 text-sm font-medium">{{ __('Four times or more') }}</label>
...
<div class="py-2 px-4 mb-4 rounded-xl  bg-blue-300">
  <div>{{ __('19. How many times have the police been called to  separate a fight with unfamiliar people?') }}'</div>
  <div class="block">
    @error('question19')
    ...
    @if($flash)
      <div>
        {{-- <div x-data="{ show: true}" x-init="setTimeout(()=> show = false, 12000)" x-show="show" class="fixed bg-green-500 text-white py-2 px-4 rounded-xl bottom-3 right-3 text-sm alert alert-success">--}}
            <span class="  text-green-900  bg-transparent">{{  __('You have successfully submitted your answers.') }}{{ __('Thank you!') }}</span>
    </div>
    @endif
