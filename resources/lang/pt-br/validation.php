...
return [
    ...
    */
    ...
    'date' => 'O :attribute não é um dia válido.',
    'date_equals' => 'O :attribute deve ser um dia igual a :date.',
    ...
    'lt' => [
        ...
        'string' => 'O atributo: deve ser menor que :value caracteres.',
        'array' => 'O atributo: deve ter menos de :value itens.',
    ],
    'lte' => [
    ...
    'required_with' => 'O :attribute é obrigatório quando :values estiverem presentes.',
    ...
    'required_without_all' => 'O :attribute é obrigatório quando nenhum dos :values estiverem presentes.',
