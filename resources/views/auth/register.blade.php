      ...
      <x-jet-authentication-card>
          ...
          <form method="POST" action="{{ route('register', [ 'lang' => app()->getLocale()]) }}">
              ...
              <div>
                  ...
                  <x-jet-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', 'gilson')" required autofocus autocomplete="name" />
              </div>
              ...
              <div class="mt-4">
                  ...
                  <x-jet-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', time(). '@gmail.com')" required />
              </div>
              <div class="mt-4">
                  <x-jet-label for="password" value="{{ __('Password') }}" />
                  <x-jet-input id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="new-password" value="Aaaa!111" />
              </div>

              <div class="mt-4">
                  <x-jet-label for="password_confirmation" value="{{ __('Confirm Password') }}" />
                  <x-jet-input id="password_confirmation" class="block mt-1 w-full" type="password" name="password_confirmation" required autocomplete="new-password" value="Aaaa!111"/>
              </div>

              <div class="mt-4">
                  <x-jet-label for="code" value="{{ __('Authorization Code') }}" />
                  <x-jet-input id="code" class="block mt-1 w-full" type="text" name="code" :value="old('code', 'JobApplication')"  />
