	...
	<div class="" x-data="urls()" x-init="init"  >
		<div class="relative flex justify-end h-8 mt-2">
			...
			<div @click.away="language = false"
				...
				<div >
					<!-- svg en starts-->
						<div x-show="lang == '/en'" x-cloak class="flex bg-blue-200 cursor-pointer mb-3" @click="language = false">
					...
					<!-- svg en ends-->
					<!-- svg br starts-->
						<div  x-show="lang == '/pt-br'" x-cloak class="flex bg-blue-200 cursor-pointer" @click="language = false">
