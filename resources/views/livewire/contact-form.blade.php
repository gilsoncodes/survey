...
<div class="py-2 px-4 rounded-xl  bg-blue-300">
    ...
    @if($hasAnyError)
      ...
      <div class="rounded-xl bg-white my-3  text-red-500 text-center px-2 py-2">
        {{ __('Your answers were not sent. Please, fix the errors before resubmitting the survey.') }}
      </div>
    @endif
