<nav x-data="{ open: false, top: true  }" class="fixed top-0 left-0 z-10 w-full bg-white border-b border-gray-100"><!-- fixed -->
	<x-top-navigation />
        ...
        <div class="flex justify-between h-16 ">
            ...
            <div class="flex">
                ...
                <div class="hidden md:-my-px md:ml-9 md:flex"> <!-- Home -->
                    ...
                    <x-jet-nav-link href="{{ route('home', [ 'lang' => app()->getLocale()]) }}" :active="request()->routeIs('home')">
												<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        {{ __('Home') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden md:-my-px md:ml-9 md:flex"> <!-- Services -->
                    <x-jet-nav-link href="{{ route('services', [ 'lang' => app()->getLocale()]) }}" :active="request()->routeIs('services')">
                ...
                <div class="hidden md:-my-px md:ml-9 md:flex"> <!-- Contact -->
                    <x-jet-nav-link href="{{ route('contact', [ 'lang' => app()->getLocale()]) }}" :active="request()->routeIs('contact')">
            ...
            <div class="flex justify-between h-16">
                    ...
                    <div class="ml-3 relative">
                        <x-jet-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-jet-dropdown-link href="{{ route('dashboard', [ 'lang' => app()->getLocale()]) }}"><!-- dashboard -->
                                    {{ __('Dashboard') }}
                                </x-jet-dropdown-link>
                                <x-jet-dropdown-link href="{{ route('profile.show', [ 'lang' => app()->getLocale()]) }}"><!-- profile -->
                                    {{ __('Profile') }}
                                </x-jet-dropdown-link>
                                <div class="border-t border-gray-100"></div>
                                <!-- Authentication -->
                                <form method="POST" action="{{ route('logout', [ 'lang' => app()->getLocale()]) }}"><!-- Log Out -->
                                    @csrf
                                    <x-jet-dropdown-link href="{{ route('logout', [ 'lang' => app()->getLocale()]) }}"
                ...
                <div class="hidden md:-my-px md:ml-7 md:flex"> <!-- Log in -->
                    <x-jet-nav-link href="{{ route('login', [ 'lang' => app()->getLocale()]) }}" :active="request()->routeIs('login')">
            ...
            <div class="bg-white "> <!-- menu Wrapper -->
              ...
              <div class="block px-4 py-2 text-xs text-gray-400">
                ...
                <div class="pt-1 pb-2 space-y-1"> <!-- Services -->
                    <x-jet-responsive-nav-link href="{{ route('services', [ 'lang' => app()->getLocale()]) }}" :active="request()->routeIs('services')">
                        {{ __('Services') }}
                    </x-jet-responsive-nav-link>
                </div>
                <div class="pt-1 pb-2 space-y-1"> <!-- Contact -->
                    <x-jet-responsive-nav-link href="{{ route('contact', [ 'lang' => app()->getLocale()]) }}" :active="request()->routeIs('contact')">
                        {{ __('Contact') }}
                    </x-jet-responsive-nav-link>
                </div>
            ...
            <div class="bg-white"> <!-- account wrapper-->
                ...
                <div class="pt-4 pb-1">
                    ...
                    <div class="pt-1 pb-2 space-y-1"> <!-- Dashboard -->
                        <x-jet-responsive-nav-link href="{{ route('dashboard', [ 'lang' => app()->getLocale()]) }}" :active="request()->routeIs('dashboard')">
                            {{ __('Dashboard') }}
                        </x-jet-responsive-nav-link>
                    </div>
                    <div class="mt-1  space-y-1">
                        <x-jet-responsive-nav-link href="{{ route('profile.show', [ 'lang' => app()->getLocale()]) }}"
                        ...
                        <form method="POST" action="{{ route('logout', [ 'lang' => app()->getLocale()]) }}">
                            @csrf
                            <x-jet-responsive-nav-link href="{{ route('logout', [ 'lang' => app()->getLocale()]) }}"
                                                       onclick="event.preventDefault();
                                                            this.closest('form').submit();">
                                {{ __('Log Out') }}
                            </x-jet-responsive-nav-link>
                ...
                <div class="pt-4 pb-1">
                    <div class="pt-1 pb-2 space-y-1"> <!-- Log in -->
                        <x-jet-responsive-nav-link href="{{ route('login', [ 'lang' => app()->getLocale()]) }}" :active="request()->routeIs('login')">
                            {{ __('Log in') }}
                        </x-jet-responsive-nav-link>
                    </div>
                </div>
